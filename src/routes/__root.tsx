...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dinigaas Trading S.C. — Education & Healthcare in Sheger City" },
      { property: "og:description", content: "Dinigaas Gateway is a full-stack corporate website for Dinigaas Trading S.C." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Dinigaas Trading S.C. — Education & Healthcare in Sheger City" },
      { name: "description", content: "Dinigaas Gateway is a full-stack corporate website for Dinigaas Trading S.C." },
      { name: "twitter:description", content: "Dinigaas Gateway is a full-stack corporate website for Dinigaas Trading S.C." },
